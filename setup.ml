...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5cca8bd00be1e891b16dae4ba10f695e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://optcomp.forge.ocamlcore.org/";
          synopsis = "Optional compilation with cpp-like directives";
          description =
            Some
              [
                 OASISText.Para
                   "Optcomp is a syntax extension which handles cpp-like directives in ocaml source files. It uses camlp4 so it is more OCaml friendly."
              ];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build binaries";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "optcomp_o.ml"});
               Executable
                 ({
                     cs_name = "optcomp-r";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "optcomp_r.ml"});
               Doc
                 ({
                     cs_name = "optcomp-api";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for optcomp";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/diml/optcomp.git";
                      src_repo_browser =
                        Some "https://github.com/diml/optcomp";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "B\187\2203;\230\229r@/\189\149\175rW\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
